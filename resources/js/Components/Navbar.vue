            ...
            <ul class="navbar-nav navbar-align">
                ...
                <!-- <li class="nav-item dropdown">
                    <a class="nav-icon dropdown-toggle" href="#" id="messagesDropdown" data-bs-toggle="dropdown">
                        <div class="position-relative">
                            <i class="far fa-comment align-middle"></i>
                        </div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0"
                        ...
                        <div class="list-group">
                            <a href="#" class="list-group-item">
                                <div class="row g-0 align-items-center">
                                    <div class="col-2">
                                        <img src="@/Assets/images/avatar-male.png"
                            ...
                            <a href="#" class="list-group-item">
                                <div class="row g-0 align-items-center">
                                    <div class="col-2">
                                        <img src="@/Assets/avatars/avatar-2.jpg" class="avatar img-fluid rounded-circle"
                                            alt="William Harris" />
                                    </div>
                                    <div class="col-10 ps-2">
                            ...
                            <a href="#" class="list-group-item">
                                <div class="row g-0 align-items-center">
                                    <div class="col-2">
                                        <img src="@/Assets/avatars/avatar-4.jpg" class="avatar img-fluid rounded-circle"
                                            alt="Christina Mason" />
                                    </div>
                                    <div class="col-10 ps-2">
                            ...
                            <a href="#" class="list-group-item">
                                <div class="row g-0 align-items-center">
                                    <div class="col-2">
                                        <img src="@/Assets/avatars/avatar-3.jpg" class="avatar img-fluid rounded-circle"
                                            alt="Sharon Lessman" />
                                    </div>
                                    <div class="col-10 ps-2">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                        <img src="@/Assets/images/avatar-male.png" class="avatar img-fluid rounded me-1"
                            alt="Charles Hall" />
